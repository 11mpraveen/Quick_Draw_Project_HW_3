...
if(drawn_sketch==sketch){
    answer_holder = "set";
    score = score+1
    document.getElementById("d_score").innerHTML = "score:" + score;
}
}

function check_sketch(){
timer_counter = timer_counter + 1;
document.getElementById("d_time").innerHTML = "time:" + timer_counter;
...
function gotResult(error,results){
    if(error){
        ...
        console.log(results);
        document.getElementById("to_be_drawn").innerHTML = results[0].label;
        document.getElementById("conf").innerHTML = Math.floor(results[0].confidence*100)+"%";
